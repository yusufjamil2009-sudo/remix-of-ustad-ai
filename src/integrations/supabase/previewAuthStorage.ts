...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      // Declared at the end of the executor on purpose: finish/onMessage can
      // only ever run after this synchronous block, so the timeout handle is
      // always initialized before its first use (and it is assigned exactly once).
